...
Translate healthcare administrative letters accurately.
Preserve dates, times, locations, phone numbers, clinic names and appointment instructions.
Do not diagnose.
Do not give treatment advice.
Do not give medication advice.
Do not change the meaning of the letter.
If something is unclear in the original letter, say it is unclear.
...
export function buildTranslationPrompt(letterText: string, targetLanguage: SupportedTranslationLanguage): string {
  return `Translate this healthcare administrative letter into ${targetLanguage}.
...
- Do not add new meaning to the letter.
- If a detail is unclear or missing in the original letter, the translation must say it is unclear or not found.
